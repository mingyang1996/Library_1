...
<%
	...
	int reader_password,reader_IDnumber,reader_allow;
	...
	reader_allow =Integer.parseInt(request.getParameter("reader_allow"));
	System.out.println("成功修改一条读者信息!");
	ItemsDAO itemsDao = new ItemsDAO();
	itemsDao.management_reader(reader_id,reader_password,reader_type,reader_IDnumber,reader_phone,reader_allow);
...
<body class="cd-about">
    <div class="cd-about cd-main-content" style="background-color: #283040;">
        <div style="background-color: #283040;">
            <div style="FONT-SIZE: 50pt; WIDTH: 100%;margin-top: 180px; margin-bottom:40px;COLOR: #e6e6e6; LINE-HEIGHT: 150%; FONT-FAMILY: 华文行楷">添加成功！</div>
